...
class StreamFuture:
    ...
    async def connect(self):
        ...
        log.info("Connected to Binance StreamFuture WebSocket")
    ...
    async def disconnect(self):
        ...
        if self.connection:
            ...
            log.error(f"{Fore.RED}Disconnected from Binance Stream Future WebSocket")
    ...
    #     log.info(f"{Fore.RED}Connection closed: {e} {Fore.RESET}")
    # except Exception as err:
    #     log.info(f"{Fore.RED}Error: {err} {Fore.RESET}", file=sys.stderr)
    ...
    async def subscribe_timeframe(timeframe: str = "1m", on_close: Coroutine = None, on_remaining: Coroutine = None) -> Callable:
        ...
        if klines and len(klines) > 0:
            ...
            try:
                ...
                log.info(f"{Fore.RED}Task cancelled cleanly")
            except Exception as err:
                raise err
